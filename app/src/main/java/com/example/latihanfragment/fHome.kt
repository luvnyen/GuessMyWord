...
class fHome : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val _eNama = view.findViewById<EditText>(R.id.eName)
        val _bHomePlay = view.findViewById<Button>(R.id.bHomePlay)
        _bHomePlay.setOnClickListener {
            if (_eNama.text.toString().trim() == "") {
                _eNama.setError("Name cannot be empty.")
            } else {
                val mBundle = Bundle()
                mBundle.putString("Name", _eNama.text.toString())
                val mfPlay = fPlay()
        ...
        val _bHistory = view.findViewById<Button>(R.id.bHistory)
